...
class TestEventValidator(unittest.TestCase):
    ...
    def test_validate_trigger_uncertainty(self):
        ...
        self.assertEqual(self.trigger_events["events"][0]["trigger"]["condition"], "greater_than")
        ...
        # 조건이 변경되었는지 확인
        self.assertEqual(modified_events["events"][0]["trigger"]["condition"], "not_supported_condition")
        self.assertNotEqual(self.trigger_events["events"][0]["trigger"]["condition"], 
...
class TestEventGenerator(unittest.TestCase):
    ...
    def test_generate_events_tradeoff(self, mock_call_api):
        ...
        # 이벤트 생성
        events = generator.generate_events(category="daily_routine", n=1, seed=42, variants=False)
    ...
    def test_create_prompt_uncertainty(self, mock_call_api):
        ...
        categories = ["daily_routine", "crisis_events", "opportunity", "human_drama", "chain_scenario"]
...
class TestIntegrationPipeline(unittest.TestCase):
    ...
    def test_pipeline_resilience_uncertainty(self):
        ...
        with open(corrupt_file, 'w', encoding='utf-8') as f:
            f.write('{"events": [{"id": "corrupt_event", "category": "daily_routine"')  # 불완전한 JSON
