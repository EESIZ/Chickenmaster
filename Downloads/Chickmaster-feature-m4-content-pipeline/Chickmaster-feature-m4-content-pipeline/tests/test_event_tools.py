...
class TestEventBankIndexer(unittest.TestCase):
    ...
    def test_update_metrics_uncertainty(self):
        ...
        self.assertAlmostEqual(updated_metadata["metrics"]["cultural_authenticity"], 0.9 * 0.7, places=2)
    ...
    def test_process_noRightAnswer(self):
        ...
        # 이벤트 파일 확인
        self.assertTrue(os.path.exists(os.path.join(self.output_dir, "daily_routine", "test_event_001.json")))
        self.assertTrue(os.path.exists(os.path.join(self.output_dir, "crisis_events", "test_event_002.json")))
