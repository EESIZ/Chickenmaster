...
from src.storyteller.domain.models import (
    StoryContext, MetricsHistory, RecentEvent, StoryPattern
)
...
class TestHelperMethods:
    ...
    def test_analyze_situation_tone(self, storyteller_service):
        ...
        # 긍정적 상황
        positive_metrics = {
            "money": 20000, "reputation": 80, "happiness": 80, "pain": 20
        }
        ...
        # 부정적 상황
        negative_metrics = {
            "money": 2000, "reputation": 20, "happiness": 20, "pain": 80
        }
        ...
        neutral_metrics = {
            "money": 8000, "reputation": 45, "happiness": 45, "pain": 55
        }
    ...
    def test_generate_metric_status_description(self, storyteller_service):
        ...
        description = storyteller_service._generate_metric_status_description(high_reputation_metrics)
        assert "좋은 평판을 얻고 있습니다" in description
        
        # 높은 행복도 상황
        high_happiness_metrics = {"money": 10000, "reputation": 50, "happiness": 80}
        description = storyteller_service._generate_metric_status_description(high_happiness_metrics)
    ...
    def test_convert_to_game_state(self, storyteller_service):
        ...
        history = MetricsHistory(
            day=2,
            metrics={"money": 8000.5, "reputation": 65.3, "happiness": 70.1, "pain": 30.8}
        )
        recent_event = RecentEvent(
            day=1, event_id="test_event", severity=0.5, effects={}
        )
