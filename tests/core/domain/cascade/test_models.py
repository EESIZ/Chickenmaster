...
class MockGameState(GameState):
    ...
    metrics: dict = field(default_factory=lambda: {"reputation": 0.7, "cash": 1000, "customer_satisfaction": 0.8})
...
class TestCascadeResult(unittest.TestCase):
    ...
    def test_get_most_affected_metric(self):
        ...
        result1 = CascadeResult(
            events=(),
            pending_events=(),
            metrics_impact=metrics_impact1,
            max_depth_reached=0
        )
        ...
        result2 = CascadeResult(
            events=(),
            pending_events=(),
            metrics_impact=metrics_impact2,
            max_depth_reached=0
        )
        ...
        result3 = CascadeResult(
            events=(),
            pending_events=(),
            metrics_impact=metrics_impact3,
            max_depth_reached=0
        )
