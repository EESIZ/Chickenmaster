        ...
        "choices": [
            {
                ...
                "text_en": "Choice 1",
                "effects": [
                    {"metric": "happiness", "formula": "10", "message": "행복이 증가했습니다."},
                    {"metric": "pain", "formula": "-10", "message": "고통이 감소했습니다."}
                ]
            },
            {
                "id": "choice_2",
                ...
                "text_en": "Choice 2",
                "effects": [
                    {"metric": "happiness", "formula": "-5", "message": "행복이 감소했습니다."},
                    {"metric": "pain", "formula": "5", "message": "고통이 증가했습니다."},
                    {"metric": "money", "formula": "200", "message": "돈이 증가했습니다."}
                ]
            }
        ]
    }
        ...
        "choices": [
            {
                ...
                "effects": [
                    {"metric": "happiness", "formula": "5", "message": "행복이 증가했습니다."}
                ],
                "cascade_events": [
                    {
                        "id": "test_event_1",
                        "condition": {"metric": "money", "operator": "greater_than", "value": 1000}
                    }
                ]
            }
        ]
...
def test_condition_evaluation():
    ...
    # 다양한 조건 테스트
    assert simulator._evaluate_condition({"metric": "money", "operator": "greater_than", "value": 1000}, state)
    assert not simulator._evaluate_condition({"metric": "money", "operator": "less_than", "value": 1000}, state)
    assert simulator._evaluate_condition({"metric": "happiness", "operator": "equal", "value": 70}, state)
    assert simulator._evaluate_condition({"metric": "customer_satisfaction", "operator": "greater_than_or_equal", "value": 85}, state)
    assert not simulator._evaluate_condition({"metric": "customer_satisfaction", "operator": "greater_than", "value": 85}, state)
    
    # 존재하지 않는 메트릭
    assert not simulator._evaluate_condition({"metric": "nonexistent", "operator": "greater_than", "value": 0}, state)
